...
namespace FriendsWithPaws
{
    ...
    sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            termList.AddRange(new string[] { "beagle", "dachshund", "jack russell terrier", "pug", 
                "west highland white terrier", "yorkshire terrier", "australian shepherd", "basset hound", 
                "border collie", "bulldog", "shar pei", "springer spaniel", "dalmatian", "doberman pinscher", 
                "german shepherd", "golden retriever", "great dane", "irish setter" });
        }
